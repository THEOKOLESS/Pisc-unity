...
public class entitiesScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (playerScript_ex05.whiteDoor > 0)
        {
        ...
        if (playerScript_ex05.redDoor1 == true)
        {   
        ...
        if (playerScript_ex05.yellowDoor1 == true)
        {
        ...
        if (playerScript_ex05.currentPlayerOnSwitch == 1)
        {
        ...
        if (playerScript_ex05.currentPlayerOnSwitch == 2)
        {
        ...
        if (playerScript_ex05.currentPlayerOnSwitch == 3)
        {
        ...
        if (playerScript_ex05.switchChangePlatformColorRedYellow == true && playerScript_ex05.playerOnSwitchRedYellow > 1)
        {
        ...
        else if (playerScript_ex05.switchChangePlatformColorRedYellow == true && playerScript_ex05.playerOnSwitchRedYellow < 2)
        {
       ...
       else if(playerScript_ex05.playerOnSwitch > 0){
